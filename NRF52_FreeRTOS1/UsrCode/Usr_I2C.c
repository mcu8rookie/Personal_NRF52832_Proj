...
void PAV3000_Read_Rawdata(void)
{
    ...
    rtn1 = Usr_I2C_Write(I2C_DEVICE1_ADDR_7B, I2C_WtBuff, I2C_WtLen, 0);     // have stop condition at the end of write.
    //rtn = Usr_I2C_Write(I2C_DEVICE1_ADDR_7B, I2C_WtBuff, I2C_WtLen, 1);   // none stop condition at the end of write.
    ...
    rtn2 = Usr_I2C_Read(I2C_DEVICE1_ADDR_7B, I2C_RdBuff, I2C_RdLen);
