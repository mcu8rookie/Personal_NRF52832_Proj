...
uint8_t Timer0_100MS_Flag;
uint8_t Timer0_1S_Flag;
...
{
    static uint32_t Timer_MainLoop_Cnt = 0;
    
    Timer_MainLoop_Cnt++;
    
    if(Timer0_100MS_Flag >= 1)
    {
        Timer0_100MS_Flag = 0;
        
        //printf("\nTm_100MS, %d,",Timer_MainLoop_Cnt);
    }
